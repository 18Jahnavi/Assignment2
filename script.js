...
function showSummary(){
  ...
  summary.innerHTML = `
    ...
    ${document.getElementById("fullName").value}</p>

    <p><strong>DOB:</strong>
    ${document.getElementById("dob").value}</p>
    ...
    ${document.getElementById("teamName").value}</p>

    <p><strong>Track:</strong>
    ${document.getElementById("track").value}</p>

    <p><strong>T-Shirt:</strong>
    ${document.getElementById("shirt").value}</p>
